...
const object = { method: function() { return 1; }, shorthand: shorthand };

// Fixable: prefer-arrow-callback
const result = [1, 2, 3].map((item) => { return item * 2; });
...
const jsBound = function() { return 1; };
...
void [
	myVariable, neverChanged, combined, object, result,
	jsCheckValue, jsCurly, ternaryValue, logicalValue,
